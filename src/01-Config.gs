...
const STAGES = {
  DEVELOPMENT: {
    name: 'التطوير',
    icon: '🧠',
    subtypes: ['الفكرة', 'البحث', 'المعالجة', 'اسكربت أولي']
  },
  PRE_PRODUCTION: {
    name: 'التحضير',
    icon: '📝',
    subtypes: ['قائمة الضيوف', 'الفكسز', 'إعداد الأسئلة', 'تنسيق المدن', 'تنسيق الدراما']
  },
  PRODUCTION: {
    name: 'الإنتاج',
    icon: '🎬',
  ...
  POST_ELEMENTS: {
    ...
    icon: '🎨',
    subtypes: ['جرافيك', 'مشاهد دراما', 'الصوت']
  },
  EDITING: {
    name: 'المونتاج',
    icon: '✂️',
  ...
  DELIVERY: {
    name: 'التسليم',
    icon: '📦',
    subtypes: ['مراجعة العميل', 'تصدير', 'تسليم نهائي']
  }
};
